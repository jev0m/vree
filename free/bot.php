      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/S_7_JA/6",
                   'caption'=>'هذا البوت مجاني وليس النسخه الاصليه للأشتراك تواصل معنا',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'إضافة حساب وهمي جديد ⬇️','callback_data'=>'login']],
                          [['text'=>"لشراء النسخه المدفوعه تواصل معنا👤", 'url'=>"https://t.me/alrao_bot"]],
                          [['text'=>"للأشتراك المدفوع وميزاته👑", 'url'=>"https://t.me/jnral515/759"]],
                      ]
                  ])
              ]);   
...
لمراسه المطور - @X_Q_9",
                  'reply_markup'=>json_encode([
					...
					$bot->sendphoto([
							'chat_id'=>$chatId,
							'photo'=> "https://t.me/S_7_JA/2",
							 'caption'=>'البوت مدفوع 💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'- مطور البوت .','url'=>'t.me/jnral515']],
                      ]
                  ])
              ]);   
				}
